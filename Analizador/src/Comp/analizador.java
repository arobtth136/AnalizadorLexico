 ...
 Token t;
    ...
    while (true) {
      ...
      t = jj_consume_token(IDENTIFIER);
                                   System.out.println("Nombre de funcion -> " + t.image);
      if (jj_2_1(4)) {
  ...
  static final public void VariableNormal() throws ParseException {
 Token t;
  ...
  static final public void VariableOperacion() throws ParseException {
 Token t;
    //suma = a + b 
        t = jj_consume_token(IDENTIFIER);
                     System.out.println("Variable -> " + t.image);
  ...
  static final public void VariableTexto() throws ParseException {
 Token t;
    //palabra = "texto"
        t = jj_consume_token(IDENTIFIER);
                     System.out.println("Variable -> " + t.image);
    ...
    while (true) {
      ...
      if (jj_2_31(4)) {
        t = jj_consume_token(IDENTIFIER);
                                                                                                              System.out.println("Cadena de texto -> " + t.image);
      } else if (jj_2_32(4)) {
        jj_consume_token(NUMBER);
      } else {
        jj_consume_token(-1);
  ...
  static final public void variableArray() throws ParseException {
    if (jj_2_54(4)) {
      jj_consume_token(IDENTIFIER);
      jj_consume_token(ASIGNACION);
...
//Sintaxis de la sentencia del metodo Switch
  ...
  static private boolean jj_3_34() {
    if (jj_scan_token(EOLW)) return true;
    return false;
  }
  ...
  static private boolean jj_3_216() {
    if (jj_scan_token(DOUBLECOMMA)) return true;
    return false;
  }
  ...
  static private boolean jj_3_93() {
    if (jj_scan_token(BIGEQ)) return true;
    return false;
  }
  ...
  static final private JJCalls[] jj_2_rtns = new JJCalls[223];
